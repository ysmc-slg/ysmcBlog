...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">&gt;</span></span><span class="token script"><span class="token language-javascript">
...
</code></pre></div><p>\u6DFB\u52A0\u4E00\u4E2A\u914D\u7F6E\u9879 <code>mixins</code>\uFF0C\u8FD9\u5C31\u662F\u5C40\u90E8\u6DF7\u5165\uFF0C\u5982\u679C\u6709\u591A\u4E2A\u6DF7\u5165\u7528 <code>,</code> \u9694\u5F00</p><h2 id="\u9009\u9879\u5408\u5E76" tabindex="-1"><a class="header-anchor" href="#\u9009\u9879\u5408\u5E76" aria-hidden="true">#</a> \u9009\u9879\u5408\u5E76</h2><ol><li><p>\u5F53\u7EC4\u4EF6\u548C\u6DF7\u5165\u5BF9\u8C61\u542B\u6709\u540C\u540D\u9009\u9879\u65F6\uFF0C\u8FD9\u4E9B\u9009\u9879\u5C06\u4EE5\u6070\u5F53\u7684\u65B9\u5F0F\u8FDB\u884C\u201C\u5408\u5E76\u201D\u3002\u5E76\u5728\u53D1\u751F\u51B2\u7A81\u65F6\u4EE5\u7EC4\u4EF6\u6570\u636E\u4F18\u5148\u3002</p><pre><code> \`\`\`js
 export default {
 	//\u6570\u636E
 	data() {
 			return {
 ...
 message: &quot;\u6211\u662FAPP&quot;
 \`\`\`
</code></pre></li><li><p>\u540C\u540D\u94A9\u5B50\u51FD\u6570\u5C06\u5408\u5E76\u4E3A\u4E00\u4E2A\u6570\u7EC4\uFF0C\u56E0\u6B64\u90FD\u5C06\u88AB\u8C03\u7528\u3002\u53E6\u5916\uFF0C<strong>\u6DF7\u5165\u5BF9\u8C61\u7684\u94A9\u5B50\u5C06\u5728\u7EC4\u4EF6\u81EA\u8EAB\u94A9\u5B50\u4E4B\u524D\u8C03\u7528</strong>\u3002</p><div class="language-javascript ext-js"><pre class="language-javascript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
	<span class="token comment">//\u751F\u547D\u5468\u671F</span>
	<span class="token function">created</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
		console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">&#39;\u6DF7\u5165\u7684created\u88AB\u8C03\u7528&#39;</span><span class="token punctuation">)</span>
	<span class="token punctuation">}</span>
...
\u7EC4\u4EF6\u7684created\u88AB\u8C03\u7528
</code></pre></div></li><li><p>\u503C\u4E3A\u5BF9\u8C61\u7684\u9009\u9879\uFF0C\u4F8B\u5982 <code>methods</code>\u3001<code>components</code> \u548C <code>directives</code>\uFF0C\u5C06\u88AB\u5408\u5E76\u4E3A\u540C\u4E00\u4E2A\u5BF9\u8C61\u3002\u4E24\u4E2A\u5BF9\u8C61\u952E\u540D\u51B2\u7A81\u65F6\uFF0C\u53D6\u7EC4\u4EF6\u5BF9\u8C61\u7684\u952E\u503C\u5BF9\u3002</p><div class="language-javascript ext-js"><pre class="language-javascript"><code>  <span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
 		<span class="token comment">// \u65B9\u6CD5</span>
 		methods<span class="token operator">:</span> <span class="token punctuation">{</span>
 			<span class="token function">foo2</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
 				console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">&#39;\u6DF7\u5165\u7684foo2\u88AB\u8C03\u7528&#39;</span><span class="token punctuation">)</span>
...
</code></pre></div><p><strong>\u6CE8\u610F\uFF1A</strong></p><p>\u5168\u5C40\u6DF7\u5165\u5B8C\u6210\u540E\uFF0C\u6240\u6709\u7684\u7EC4\u4EF6\u90FD\u4F1A\u88AB\u6DFB\u52A0\uFF0C\u6240\u4EE5\u8FD9\u79CD\u65B9\u5F0F\u4E00\u822C\u4E0D\u4F1A\u4F7F\u7528</p>`,20);function p(o,c){return t}var l=s(a,[["render",p]]);export{l as default};
