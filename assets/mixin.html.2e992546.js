...
## \u5168\u5C40\u6DF7\u5165
\u5168\u5C40\u6DF7\u5165\u5C31\u7B80\u5355\u7684\u591A\uFF0C\u53EA\u9700\u8981\u5728 </span><span class="token template-punctuation string">\`</span></span>main<span class="token punctuation">.</span>js<span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string"> \u5F15\u5165 </span><span class="token template-punctuation string">\`</span></span>mixin<span class="token punctuation">.</span>js<span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string">\uFF0C\u7136\u540E\u4F7F\u7528 </span><span class="token template-punctuation string">\`</span></span>Vue<span class="token punctuation">.</span><span class="token function">mixin</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token template-string"><span class="token template-punctuation string">\`</span><span class="token string"> \u5373\u53EF\u3002
...
</code></pre></div><p><strong>\u6CE8\u610F\uFF1A</strong></p><p>\u5168\u5C40\u6DF7\u5165\u5B8C\u6210\u540E\uFF0C\u6240\u6709\u7684\u7EC4\u4EF6\u90FD\u4F1A\u88AB\u6DFB\u52A0\uFF0C\u6240\u4EE5\u8FD9\u79CD\u65B9\u5F0F\u4E00\u822C\u4E0D\u4F1A\u4F7F\u7528</p>`,18);function p(o,c){return t}var l=s(a,[["render",p]]);export{l as default};
