...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">LogAspect</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p><code>@AfterReturning</code> \u8FD4\u56DE\u901A\u77E5\uFF0C\u6709\u8FD4\u56DE\u503C\u4F1A\u89E6\u53D1\u6B64\u65B9\u6CD5\uFF0C<code>@AfterThrowing</code> \u5F02\u5E38\u901A\u77E5\uFF0C\u5F53\u6709\u5F02\u5E38\u65F6\u4F1A\u89E6\u53D1\u6B64\u65B9\u6CD5\u3002\u8FD9\u4E24\u4E2A\u65B9\u6CD5\u90FD\u4F1A\u8C03\u7528 <code>handleLog</code> \u65B9\u6CD5\u5BF9 <code>SysOperLog</code> \u8FDB\u884C\u8D4B\u503C\u3002</p><p>\u5728 <code>handleLog()</code> \u65B9\u6CD5\u4E2D\uFF0C\u5BF9 status\u3001operName \u8D4B\u503C\uFF0CoperName \u6211\u8FD9\u91CC\u5199\u6B7B\u4E86\u8FD9\u91CC\u662F\u767B\u5F55\u7528\u6237\u7684\u540D\u79F0\u3002\u7136\u540E\u7ED9 ip \u548C operUrl \u8D4B\u503C\uFF0C\u5982\u679C\u6709\u5F02\u5E38\u66F4\u65B0\u72B6\u6001\u548C\u5F02\u5E38\u4FE1\u606F\u3002</p><p><code>getControllerMethodDescription()</code> \u4E2D\u83B7\u53D6\u6CE8\u89E3\u4E0A\u7684\u4FE1\u606F\u7ED9 <code>operLog</code> \u8D4B\u503C\uFF0C\u5982\u679C\u9700\u8981\u4FDD\u5B58\u53C2\u6570\u4FE1\u606F\uFF0C\u9700\u8981\u5728 <code>setRequestValue()</code> \u65B9\u6CD5\u4E2D\u5BF9\u8BF7\u6C42\u65B9\u5F0F\u8FDB\u884C\u5224\u65AD\uFF0C\u5982\u679C\u662F <code>POST</code> \u6216 <code>PUT</code> \u65B9\u5F0F\uFF0C\u83B7\u53D6\u8BF7\u6C42\u4F53\u4E2D\u7684\u5168\u90E8\u53C2\u6570\u8C03\u7528 <code>argsArrayToString()</code> \u65B9\u6CD5\u904D\u5386\u53C2\u6570\uFF0C\u540C\u65F6\u5728<code>isFilterObject()</code> \u4E2D\u5224\u65AD\u662F\u5426\u9700\u8981\u5C06\u53C2\u6570\u8FC7\u6EE4\uFF0C\u56E0\u4E3A\u6587\u4EF6\u4E0A\u4F20\u5BF9\u8C61\u7B49\u53C2\u6570\u77E5\u8BC6\u4E00\u4E2A\u4E8C\u8FDB\u5236\u4EE3\u7801\uFF0C\u6CA1\u6709\u610F\u4E49\u6240\u4EE5\u8981\u8FC7\u6EE4\u6389\uFF0C\u6700\u540E\u5C06\u53C2\u6570\u8F6C\u6210 JSON \u8FDB\u884C\u62FC\u63A5\u3002\u5982\u662F <code>GET</code> \u7B49\u5176\u4ED6\u65B9\u5F0F\uFF0C\u76F4\u63A5\u83B7\u53D6\u5730\u5740\u680F\u7684\u53C2\u6570\u8FDB\u884C\u8D4B\u503C\u3002\u6700\u540E\u5C06\u8FD4\u56DE\u503C\u4E5F\u8FDB\u884C\u8D4B\u503C\u3002</p><p>\u6700\u540E\u6267\u884C <code>AsyncManager.me().execute(AsyncFactory.recordOper(operLog));</code> \u5F02\u6B65\u4FDD\u5B58\u64CD\u4F5C\u4FE1\u606F\uFF0C\u5F02\u6B65\u64CD\u4F5C\u8BF7\u79FB\u6B65\uFF1A</p><div class="language-java ext-java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * \u5F02\u6B65\u5DE5\u5382\uFF08\u4EA7\u751F\u4EFB\u52A1\u7528\uFF09
 *
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AsyncFactory</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p><code>SpringUtils.getBean</code> \u83B7\u53D6\u88AB Spring \u7BA1\u7406\u7684 Bean\uFF0C\u5177\u4F53\u4FE1\u606F\u79FB\u6B65\uFF1A</p><div class="language-java ext-java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * \u64CD\u4F5C\u65E5\u5FD7 \u670D\u52A1\u5C42
 *
 * <span class="token keyword">@author</span> tienchin
 */</span>
...
</code></pre></div>`,30);function p(o,e){return t}var u=s(a,[["render",p]]);export{u as default};
